...
### 二叉树的常见概念
+ 真二叉树： 不含一度节点的二叉树称作_真二叉树_( `proper binary tree` )
+ 满二叉树：满二叉树也是真二叉树，且所有的叶子节点都在最后一层
+ 完全二叉树： 深度为k的有n个结点的_二叉树_，对树中的结点按从上至下、从左到右的顺序进行编号，如果编号为i（1≤i≤n）的结点与满_二叉树_中编号为i的结点在_二叉树_中的位置相同，则这棵_二叉树_称为_完全二叉树_。
...
### 实现二叉搜索树
<!-- 这是一张图片，ocr 内容为：19  15 22 20 -->
![](https://cdn.nlark.com/yuque/0/2021/png/738210/1613959290032-8ce3f590-4fe6-4be6-8707-577ac9a339ac.png)
...
<!-- 这是一张图片，ocr 内容为：inorderTraversal preorderTraversal 3 10 10 6 15 22 20 LevelOrderTraversal postorderTraversal 10 10 2 6 8 5 5 6 15 15 22 -->
![](https://cdn.nlark.com/yuque/0/2021/png/738210/1613959670012-800a72fd-b138-44ee-96f9-223f0d7760f2.png)
...
> 通过调用传入的`visit`方法可以将遍历到的结果传入到visit函数中。用户可以自行处理每次遍历到的结果。
>
...
## 七、前驱节点 & 后继节点
对一棵二叉树进行中序遍历,遍历后的顺序,当前节点的前一个节点为该节点的_前驱节点_;
...
对一棵二叉树进行中序遍历,遍历后的顺序,当前节点的下一个节点为该节点的_后继节点_;
