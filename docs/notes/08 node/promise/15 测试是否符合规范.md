# 安装依赖
```javascript
sudo cnpm i promises-aplus-tests -g
```
...
# 执行结果
<!-- 这是一张图片，ocr 内容为：T381 Robin@Royan:-/Downloads/codezf/promise-demomy-promise eventually-rejected Theyalueis1withNumber.prototypen emodifiedtohaveathenmethod -mypromise -mypromise-- already-fulfilled -mypromise- -mypromise--- immediately-fulfilled ----mypromise- -mypromise- eventually-fulfilled --mypromise--- 一mypromise-- already-rejected -mypromise -mypromise- immediateLy-rejectd mypromise promise- eventually-rejected 872passing(17s) -->
![](https://cdn.nlark.com/yuque/0/2020/png/738210/1607074959802-55afc33b-2985-4460-958b-4e5161a3840a.png)
