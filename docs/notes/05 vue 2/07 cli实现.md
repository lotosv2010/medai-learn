...
只要提到脚手架你就会想到，_vue-cli_ 、 _create-react-app_ 、 _dva-cli_ ... 他们的特点不用多说那就是**专一**！ 但是在公司中你会发现有以下一系列的问题!
...
> <font style="color:rgb(28, 30, 33);">使用命令行快速启动一个脚手架，实现自动化和智能化。</font>
>
> <font style="color:rgb(28, 30, 33);">开发命令行工具的关键依赖：</font>
>
> + <font style="color:rgb(28, 30, 33);">inquirer、enquirer、prompts: 处理复杂的用户输入，完成命令行输入交互。</font>
> + <font style="color:rgb(28, 30, 33);">chalk</font><font style="color:rgb(28, 30, 33);">、</font><font style="color:rgb(28, 30, 33);">kleur</font><font style="color:rgb(28, 30, 33);">: 使终端输出彩色信息文案。</font>
> + <font style="color:rgb(28, 30, 33);">ora</font><font style="color:rgb(28, 30, 33);">：命让令行出现好看的 Spinner。</font>
> + <font style="color:rgb(28, 30, 33);">boxen</font><font style="color:rgb(28, 30, 33);">: 可以在命令行画出 Boxes 区块。</font>
> + <font style="color:rgb(28, 30, 33);">listr</font><font style="color:rgb(28, 30, 33);">: 可以在命令行画出进度列表。</font>
> + <font style="color:rgb(28, 30, 33);">meow</font><font style="color:rgb(28, 30, 33);">、</font><font style="color:rgb(28, 30, 33);">arg</font><font style="color:rgb(28, 30, 33);">: 进行基础的命令行参数解析。</font>
> + <font style="color:rgb(28, 30, 33);">commander</font><font style="color:rgb(28, 30, 33);">、</font><font style="color:rgb(28, 30, 33);">yargs</font><font style="color:rgb(28, 30, 33);">: 进行更加复杂的命令行参数解析。</font>
> + <font style="color:rgb(28, 30, 33);">shelljs: 使用 javascript 编写 shell 命令。</font>
>
...
<!-- 这是一张图片，ocr 内容为：T381 robin@Royan:-/Downloads/01git/gt-cli gt-cligit:main eslint--init npxe useESLint? HowwouLdyouliketous problems Whattypeofmodulesdoesyourprojectuse? commonjs Whichframeworkdoesyourprojectuse? none DoesyourprojectuseTypeScript? No/Yes Where browser doesyourcoderun? Whatformatdoy JSON youwantyourconfigfiletobein? Successfullycreatedeslintrc.jnfilein/usrs/robin/owloads/git/tcli gt-cligit:main) -->
![](https://cdn.nlark.com/yuque/0/2021/png/738210/1610981738462-50f7ce37-a33a-48d9-af44-b01282e83a2d.png)
...
### 配置指令命令
<font style="color:#2C3E50;">根据我们想要实现的功能配置执行动作，遍历产生对应的命令</font>
...
### 编写help命令
<font style="color:#2C3E50;">监听help命令打印帮助信息</font>

<font style="color:#2C3E50;"></font>

+ <font style="color:#2C3E50;">安装依赖</font>
...
<font style="color:#2C3E50;">发现在安装的时候体验很不好没有任何提示,而且最终的结果我希望是可以供用户选择的！</font>
...
<font style="color:#2C3E50;">编</font><font style="color:#2C3E50;">写</font>`config.js`
...
[前端工程化之创建项目_大前端_春生_InfoQ写作社区](https://xie.infoq.cn/article/79e757dc3bd872b504c1cf99f)
